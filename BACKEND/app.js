...
const contractAddress = "0x4d2E0830CC8bfC4BB60dc9dfe6875C7de7cCaE23";
...
app.post("/createTender", async (req, res) => {
  try {
    ...
    // console.log("hello");
    const tender = await contract.methods.createTender("09876543wetyukjhgfdxc").call();
    //console.log(tender);
    //const num = tcount;
    ...
    //     numId,name,date
    // }
    res.status(200).json({ tender, status: 200 })
  } catch (error) {
